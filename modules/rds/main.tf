...
resource "aws_db_instance" "this" {
  ...
  db_name                             = var.db_name
  username                            = jsondecode(data.aws_secretsmanager_secret_version.target_database_autogenerated_secret_version.secret_string)["username"]
  password                            = jsondecode(data.aws_secretsmanager_secret_version.target_database_autogenerated_secret_version.secret_string)["password"]
